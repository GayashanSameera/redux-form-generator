                        ...
                        fields.map((prefix, i) => {
                            ...
                            return (
                                <div key={i}>
                                    ...
                                    <div className={border ? "border p-3 mt-2" : ""}>{repeatingComponent(prefix)}</div>
    ...
    render() {
        ...
        return (
            <div className="pb-3 input-row">
                ...
                <div>
                    {this.state.showArrayFields && <FieldArray name={name} component={this.renderRepeatingElements} />}
                </div>
            </div>
        );
    }
